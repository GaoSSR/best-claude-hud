...
mod tests {
    ...
    #[test]
    fn input_data_accepts_string_model() {
        ...
        assert_eq!(input.model.id, "claude-opus-4-6-20260601");
        assert_eq!(input.model.display_name, "claude-opus-4-6-20260601");
    }

    #[test]
    fn input_data_accepts_object_model_and_rate_limits() {
        let input: InputData = serde_json::from_value(json!({
            "model": {
                "id": "kimi-k2.7-code",
        ...
        assert_eq!(input.model.id, "kimi-k2.7-code");
        assert_eq!(input.model.display_name, "Kimi K2.7 Code");
